...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-8">
        ...
        <div>
            ...
            <h2 class="font-playfair text-2xl font-bold text-[#1a1a2e]">Nouveau propriétaire</h2>
        </div>
    </div>

    <form method="POST" action="?page=proprietaires&action=store"
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="nom" required placeholder="Alice Martin"
            ...
            <div>
                ...
                <input type="email" name="email" required placeholder="alice@email.fr"
                       class="w-full border border-[#e8e4df] rounded-xl px-4 py-2.5 text-sm text-[#1a1a2e] focus:outline-none focus:ring-2 focus:ring-[#c9a96e]">
            </div>
        </div>

        <div id="fields-particulier" class="space-y-4 border-t border-[#e8e4df] pt-4">
        ...
        <div id="fields-professionnel" class="hidden space-y-4 border-t border-[#e8e4df] pt-4">
            ...
            <div>
                ...
                <input type="text" name="raisonSociale" placeholder="Dupont Immobilier SARL"
                       class="w-full border border-[#e8e4df] rounded-xl px-4 py-2.5 text-sm text-[#1a1a2e] focus:outline-none focus:ring-2 focus:ring-[#c9a96e]">
            </div>
            <div>
        ...
        <div class="border-t border-[#e8e4df] pt-4">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <label class="flex items-center gap-2 bg-[#f8f6f3] rounded-xl px-3 py-2 cursor-pointer hover:bg-[#e8e4df] transition-colors border border-[#e8e4df]">
                    <input type="checkbox" name="biens[]" value="<?= $bien['id'] ?>" class="w-4 h-4 accent-[#c9a96e] rounded">
                    <span class="text-xs">
